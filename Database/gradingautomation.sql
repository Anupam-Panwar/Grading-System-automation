...
CREATE TABLE `controlsheet` (
  ...
  `class_test_1` varchar(8) NOT NULL,
  `class_test_2` varchar(8) NOT NULL,
  `class_test_3` varchar(8) NOT NULL,
  `class_test_4` varchar(8) NOT NULL,
  `mid_term_1` varchar(8) NOT NULL,
  `mid_term_2` varchar(8) NOT NULL,
  `total_assessment` int(11) NOT NULL,
  `end_term` varchar(8) NOT NULL,
...
('CSL-253', 'BT19CSE002', 'Anupam Panwar', '6', '9', '0', '0', '18', '19', 52, '38', 90, 'AB'),
('CSL-253', 'BT19CSE003', 'Neha Dhyani', '10', '9', '0', '0', '19', '19', 57, '3', 60, 'CC'),
('CSL-253', 'BT19CSE011', 'Purvi Goyal', '9', '10', '0', '0', '18', '20', 57, '39', 96, 'AA'),
('CSL-253', 'BT19CSE020', 'Priyanshu Upadhyay', '10', '10', '0', '0', '19', '19', 58, '3', 61, 'CC'),
...
INSERT INTO `flag` (`user_id`, `mt1`, `mt2`, `ct`, `et`) VALUES
(6, 0, 0, 0, 0);
...
--
ALTER TABLE `flag`
  ADD CONSTRAINT `flag_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
